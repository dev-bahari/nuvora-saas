...
Ruling: Task 1 may replace only the legacy internal invoice navigation anchor with Next `Link` to restore lint. No invoice visual or behavior changes belong to Task 1.
